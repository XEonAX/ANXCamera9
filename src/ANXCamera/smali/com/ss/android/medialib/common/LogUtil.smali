...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/medialib/common/LogUtil;->APPNAME:Ljava/lang/String;

    .line 25
    const/4 v0, 0x1

    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->LOGE:B

    .line 26
    const/4 v1, 0x2

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->LOGW:B

    .line 27
    const/4 v1, 0x4

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->LOGI:B

    .line 28
    const/16 v1, 0x8

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->LOGD:B

    .line 29
    const/16 v1, 0x10

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->LOGV:B

    .line 37
    const/4 v1, 0x0

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_N:B

    .line 38
    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_E:B

    .line 39
    const/4 v0, 0x3

    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_W:B

    .line 40
    const/4 v0, 0x7

    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_I:B

    .line 41
    const/16 v0, 0xf

    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_D:B

    .line 42
    const/16 v1, 0x1f

    sput-byte v1, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL_V:B

    .line 44
    sput-byte v0, Lcom/ss/android/medialib/common/LogUtil;->DEBUG_LEVEL:B
