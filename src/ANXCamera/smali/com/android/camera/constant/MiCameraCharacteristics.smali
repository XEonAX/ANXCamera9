...
.field public static final FOVC_SUPPORTED:Landroid/hardware/camera2/CameraCharacteristics$Key;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/hardware/camera2/CameraCharacteristics$Key<",
            "Ljava/lang/Byte;",
...
.field private static final KEY_FOVC_SUPPORTED:Ljava/lang/String; = "com.xiaomi.camera.supportedfeatures.fovcEnable"
...
.field private static final KEY_MFNR_BOKEH_SUPPORTED:Ljava/lang/String; = "xiaomi.capabilities.mfnr_bokeh_supported"
...
.field private static final KEY_SCREEN_LIGHT_BRIGHTNESS:Ljava/lang/String; = "xiaomi.flash.screenLight.brightness"
...
.field public static final MFNR_BOKEH_SUPPORTED:Landroid/hardware/camera2/CameraCharacteristics$Key;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/hardware/camera2/CameraCharacteristics$Key<",
            "Ljava/lang/Byte;",
...
.field public static SCREEN_LIGHT_BRIGHTNESS:Landroid/hardware/camera2/CameraCharacteristics$Key;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/hardware/camera2/CameraCharacteristics$Key<",
            "Ljava/lang/Integer;",
...
.method static constructor <clinit>()V
    ...
    const-string v1, "xiaomi.flash.screenLight.brightness"

    const-class v2, Ljava/lang/Integer;

    invoke-direct {v0, v1, v2}, Landroid/hardware/camera2/CameraCharacteristics$Key;-><init>(Ljava/lang/String;Ljava/lang/Class;)V

    sput-object v0, Lcom/android/camera/constant/MiCameraCharacteristics;->SCREEN_LIGHT_BRIGHTNESS:Landroid/hardware/camera2/CameraCharacteristics$Key;

    .line 83
    new-instance v0, Landroid/hardware/camera2/CameraCharacteristics$Key;

    const-string v1, "xiaomi.capabilities.mfnr_bokeh_supported"

    const-class v2, Ljava/lang/Byte;

    invoke-direct {v0, v1, v2}, Landroid/hardware/camera2/CameraCharacteristics$Key;-><init>(Ljava/lang/String;Ljava/lang/Class;)V

    sput-object v0, Lcom/android/camera/constant/MiCameraCharacteristics;->MFNR_BOKEH_SUPPORTED:Landroid/hardware/camera2/CameraCharacteristics$Key;

    .line 89
    new-instance v0, Landroid/hardware/camera2/CameraCharacteristics$Key;

    const-string v1, "com.xiaomi.camera.supportedfeatures.fovcEnable"

    const-class v2, Ljava/lang/Byte;

    invoke-direct {v0, v1, v2}, Landroid/hardware/camera2/CameraCharacteristics$Key;-><init>(Ljava/lang/String;Ljava/lang/Class;)V

    sput-object v0, Lcom/android/camera/constant/MiCameraCharacteristics;->FOVC_SUPPORTED:Landroid/hardware/camera2/CameraCharacteristics$Key;
