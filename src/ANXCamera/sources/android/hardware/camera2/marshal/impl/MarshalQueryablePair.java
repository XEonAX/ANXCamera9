    ...
    private class MarshalerPair extends Marshaler<Pair<T1, T2>> {
        ...
        protected MarshalerPair(TypeReference<Pair<T1, T2>> typeReference, int nativeType) {
            ...
            try {
                ...
                this.mNestedTypeMarshalerFirst = MarshalRegistryANX.getMarshaler(TypeReference.createSpecializedTypeReference(paramType.getActualTypeArguments()[0]), this.mNativeType);
                this.mNestedTypeMarshalerSecond = MarshalRegistryANX.getMarshaler(TypeReference.createSpecializedTypeReference(paramType.getActualTypeArguments()[1]), this.mNativeType);
                try {
