...
public final class PlaybackStateCompat implements Parcelable {
    ...
    /* synthetic */ PlaybackStateCompat(int x0, long x1, long x2, float x3, long x4, CharSequence x5, long x6, List x7, long x8, Bundle x9, AnonymousClass1 x10) {
    ...
    public static PlaybackStateCompat fromPlaybackState(Object stateObj) {
        ...
        PlaybackStateCompat playbackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(stateObj), PlaybackStateCompatApi21.getPosition(stateObj), PlaybackStateCompatApi21.getBufferedPosition(stateObj), PlaybackStateCompatApi21.getPlaybackSpeed(stateObj), PlaybackStateCompatApi21.getActions(stateObj), PlaybackStateCompatApi21.getErrorMessage(stateObj), PlaybackStateCompatApi21.getLastPositionUpdateTime(stateObj), customActions, PlaybackStateCompatApi21.getActiveQueueItemId(stateObj), state);
