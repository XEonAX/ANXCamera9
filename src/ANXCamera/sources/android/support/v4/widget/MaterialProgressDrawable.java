        ...
        Animation animation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (interpolatedTime <= 0.5f) {
                    ring.setStartTrim(((MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(interpolatedTime / 0.5f)) + startingTrim);
                }
                if (interpolatedTime > 0.5f) {
                    ring.setEndTrim((MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((interpolatedTime - 0.5f) / 0.5f) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc)) + startingEndTrim);
                }
