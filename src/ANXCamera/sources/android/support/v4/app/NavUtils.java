...
public class NavUtils {
    ...
    static class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, target) == null ? IntentCompat.makeMainActivity(target) : new Intent().setComponent(target);
        ...
        public String getParentActivityName(Context context, ActivityInfo info) {
            ...
            if (parentActivity.charAt(0) == '.') {
                ...
                stringBuilder.append(parentActivity);
                parentActivity = stringBuilder.toString();
            }
