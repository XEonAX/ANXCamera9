...
public class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            for (i = 0; i < count; i++) {
                if (skipIndex != i) {
                    sumX += MotionEventCompat.getX(motionEvent, i);
                    sumY += MotionEventCompat.getY(motionEvent, i);
                }
            }
            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityX = VelocityTrackerCompat.getXVelocity(velocityTracker, pointerId);
                ...
                case 6:
                    ...
                    pointerId = MotionEventCompat.getActionIndex(ev);
                    distance = MotionEventCompat.getPointerId(motionEvent, pointerId);
                    float x1 = VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, distance);
                    velocityX = VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, distance);
                    int i3 = 0;
                    while (true) {
                        int action2 = action;
                        action = i3;
                        ...
                        if (action < count) {
                            if (action == pointerId) {
                                ...
                                z = pointerUp;
                                pointerUp = MotionEventCompat.getPointerId(motionEvent, action);
                                i2 = skipIndex;
                                upIndex = pointerId;
                                if ((VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, pointerUp) * x1) + (VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, pointerUp) * velocityX) < 0.0f) {
