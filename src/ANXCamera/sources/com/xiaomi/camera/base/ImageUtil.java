...
public final class ImageUtil {
    ...
    public static ByteBuffer removePadding(Plane plane, int i, int i2) {
        ...
        r6 = new Object[4];
        int i3 = 0;
        r6[0] = Integer.valueOf(rowStride);
        r6[1] = Integer.valueOf(pixelStride);
        r6[2] = Integer.valueOf(i);
        r6[3] = Integer.valueOf(i2);
        Log.d(str, String.format("removePadding: rowStride=%d pixelStride=%d size=%dx%d", r6));
        i *= pixelStride;
        if (rowStride == i) {
            return buffer;
        }
        ...
        String str3 = TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("removePadding: cost=");
