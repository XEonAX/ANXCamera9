...
public class SnapKeyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (VERSION.SDK_INT < 21 || !b.gR() || !"miui.intent.action.CAMERA_KEY_BUTTON".equals(intent.getAction()) || !SnapCamera.isSnapEnabled(context) || !PermissionManager.checkCameraLaunchPermissions()) {
            return;
        }
