...
public class CameraStat {
    ...
    public static final String PARAM_LIVE_MUSIC_ICON_CLICK = "抖音音乐1";
    public static final String PARAM_LIVE_MUSIC_NAME = "抖音音乐类型";
    public static final String PARAM_LIVE_MUSIC_ON = "抖音音乐2";
