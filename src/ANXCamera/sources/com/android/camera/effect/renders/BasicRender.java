...
public class BasicRender extends ShaderRender {
    ...
    private void drawTexture(BasicTexture basicTexture, RectF rectF, RectF rectF2) {
        if (rectF2.width() > PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO && rectF2.height() > PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO && basicTexture.onBind(this.mGLCanvas)) {
