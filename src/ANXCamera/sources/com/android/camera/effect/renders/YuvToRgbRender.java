    ...
    public boolean draw(DrawAttribute drawAttribute) {
        ...
        if (isAttriSupported(drawAttribute.getTarget())) {
            if (drawAttribute.getTarget() != 11) {
                ...
                drawTexture(this.mYuvTextureIds, PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, (float) drawYuvAttribute.mWidth, (float) drawYuvAttribute.mHeight);
