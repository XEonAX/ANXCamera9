...
public class MiCameraCharacteristics {
    ...
    public static final Key<Byte> FOVC_SUPPORTED = new Key(KEY_FOVC_SUPPORTED, Byte.class);
    ...
    private static final String KEY_FOVC_SUPPORTED = "com.xiaomi.camera.supportedfeatures.fovcEnable";
    ...
    private static final String KEY_MFNR_BOKEH_SUPPORTED = "xiaomi.capabilities.mfnr_bokeh_supported";
    ...
    private static final String KEY_SCREEN_LIGHT_BRIGHTNESS = "xiaomi.flash.screenLight.brightness";
    ...
    public static final Key<Byte> MFNR_BOKEH_SUPPORTED = new Key(KEY_MFNR_BOKEH_SUPPORTED, Byte.class);
    ...
    public static Key<Integer> SCREEN_LIGHT_BRIGHTNESS = new Key(KEY_SCREEN_LIGHT_BRIGHTNESS, Integer.class);
