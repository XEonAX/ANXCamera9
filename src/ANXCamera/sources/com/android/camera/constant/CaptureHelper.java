...
public class CaptureHelper {
    ...
    public static final int STATE_WAITING_FLASH_CLOSE = 8;
    public static final int STATE_WAITING_FLASH_CLOSE_AND_STOP_PREVIEW = 10;
    public static final int STATE_WAITING_FLASH_FIRED = 9;
