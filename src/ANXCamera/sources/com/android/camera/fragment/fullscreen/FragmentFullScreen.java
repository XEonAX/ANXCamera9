...
public class FragmentFullScreen extends BaseFragment implements OnClickListener, FullScreenProtocol, HandleBackTrace, Consumer<Pair<String, String>> {
    ...
    public void notifyDataChanged(int i, int i2) {
        ...
        if (this.mLiveViewLayout != null && this.mLiveViewLayout.getVisibility() == 0 && this.mPendingSaveFinish && this.mCombineReady) {
            onCombineSuccess();
        }
    }
    ...
    private void showShareSheet() {
        ...
        if (arrayList.isEmpty()) {
            ...
            i = Math.max(Util.sWindowWidth / arrayList.size(), (int) (((float) Util.sWindowWidth) / 5.5f));
            if (this.mShareAdapter == null || this.mShareAdapter.getItemCount() != arrayList.size()) {
                this.mShareAdapter = new ShareAdapter(arrayList, this, i);
