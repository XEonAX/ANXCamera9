            ...
            switch (this.mResetType) {
                ...
                case 6:
                    ...
                    if (DataRepository.dataItemFeature().fD()) {
                        DataRepository.dataItemLive().editor().remove(CameraSettings.KEY_LIVE_MUSIC_PATH).remove(CameraSettings.KEY_LIVE_MUSIC_HINT).remove(CameraSettings.KEY_LIVE_STICKER).remove(CameraSettings.KEY_LIVE_STICKER_NAME).remove(CameraSettings.KEY_LIVE_STICKER_HINT).remove(CameraSettings.KEY_LIVE_SPEED).apply();
                        break;
                    }
                    break;
                case 4:
