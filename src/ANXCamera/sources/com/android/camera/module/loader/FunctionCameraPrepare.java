        ...
        if (this.mNeedReConfigureData) {
            ...
            switch (this.mResetType) {
                case 1:
                    ...
                    if (!(this.mTargetMode == 163 || this.mTargetMode == 165 || this.mTargetMode == 171 || this.mTargetMode == 162 || this.mTargetMode == 169 || this.mTargetMode == 168 || this.mTargetMode == 170 || this.mTargetMode == 161)) {
                        i = this.mTargetMode;
                        break;
                    }
                case 2:
                ...
                case 5:
                    ...
                    if (i2 != 174) {
                        switch (i2) {
                            case 161:
                                break;
                            case 162:
                                i2 = dataItemGlobal.getCurrentCameraId();
                                if (i2 == 0) {
                    ...
                    i2 = dataItemGlobal.getCurrentCameraId();
                    dataItemGlobal.setCameraIdTransient(i2);
                    backUp.revertRunning(dataItemRunning, dataItemGlobal.getDataBackUpKey(this.mTargetMode), i2);
                    break;
            }
            boolean fF = DataRepository.dataItemFeature().fF();
